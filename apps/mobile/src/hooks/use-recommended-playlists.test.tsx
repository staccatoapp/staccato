...
describe("useRecommendedPlaylists", () => {
  ...
  it("builds the client from the session and fetches recommendations", async () => {
    const data = { status: "ready", data: [] };
    ...
    const { result } = renderHook(() => useRecommendedPlaylists(), { wrapper });
