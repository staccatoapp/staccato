...
- whenever a user-created rule is loaded from .claude/rules or a skill is used from .claude/skills, provide constructive feedback on the use of the rule or skill. Focus on what could be improved. This will help us make it better for next time.
